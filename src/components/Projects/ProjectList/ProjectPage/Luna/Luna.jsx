    ...
    return (
        <Container>
            <div className={css.cont}>
                ...
                <span className={css.sub}><span className={css.mark}>Увага!</span> Так як проект розміщений на безкоштовному хостингу, потрібно почекати 2-3хв для запуску бекенду.</span>
                <br />
