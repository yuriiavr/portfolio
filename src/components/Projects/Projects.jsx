    ...
    return (
        <Container>
            <div>
                ...
                <span className={css.subtitle}>Recently I started my way like a Front-End Developer. My tech skills stack now are JavaScript, React, React Native and Node.js. I stadied at <a className={css.textLink} href="https://www.goit.global/">GoIT</a> and made there some pet projects. Now I'm creating my own projects, you can see them below. So this website is something like my portfolio and blog. Welcome.</span>
            </div>
